...
class Salt(MaterialFactory):
    ...
    def make_material(self) -> openmc.Material:
        ...
        lif  = openmc.Material();  lif.add_elements_from_formula('LiF', enrichment=self.li_enr, enrichment_target='Li7', enrichment_type='wo')
        bef2 = openmc.Material(); bef2.add_elements_from_formula('BeF2')
        zrf4 = openmc.Material(); zrf4.add_elements_from_formula('ZrF4')

        u234 = openmc.Material(); u234.add_nuclide('U234', 1.)
        u235 = openmc.Material(); u235.add_nuclide('U235', 1.)
        u236 = openmc.Material(); u236.add_nuclide('U236', 1.)
        u238 = openmc.Material(); u238.add_nuclide('U238', 1.)
        ...
        f    = openmc.Material(); f.add_element('F', 1.)
