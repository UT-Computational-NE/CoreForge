...
class GraphiteElement:
    ...
    Provides feature specifications (graphite meat, cladding) and a nested
    ``Pincell`` class that constructs the concentric cylindrical model.
    ...
    class Pincell(CylindricalPinCell):
        ...
        @property
        def cladding(self) -> GraphiteElement.Cladding:
            return self._cladding

        @property
        def graphite_meat(self) -> GraphiteElement.GraphiteMeat:
